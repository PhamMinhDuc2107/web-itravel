...
class AdminModel extends Model
{
   ...
   protected $allowedColumns = ['id', 'username', 'email', 'password','phone',"status","created_at", "updated_at", "deleted_at"];
   protected $hiddenColumns = ['password','created_at','updated_at','deleted_at'];
