                  ...
                  <div class="table-responsive p-0">
                     <table class="table align-items-center mb-0">
                        ...
                        <tr>
                           ...
                           <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 col-2">Tên</th>
                           ...
                           <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 col-2">Mô tả</th>
                           <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Khoảng thời gian</th>
                           <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 col-1">Giá</th>
                           <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7col-1">danh mục</th>
                           <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 col-1">Trạng thái</th>
                           <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 col-1">Hot</th>
                        ...
                        <?php if(!empty($tours)) : ?>
                           <?php foreach($tours as $item): ?>
                              <tr>
                                 ...
                                 <td class ='col-1'>
                                    <div class="d-flex px-2 py-1">
                                       <img src="<?php echo 1?>" alt="<?php echo $item['slug']?>" class="rounded-3" style="width:95px; height: 95px;">
                                    </div>
                                 </td>
                                 <td class ='col-3 '>
                                 ...
                                 <td class ='col-1'>
                                    <div class="d-flex px-2 py-1 text-center">
                                       <div class="mb-0 text-sm "><?php echo 10000?></div>
                                    </div>
                                 </td>
                                 <td class ='col-1'>
                                       <div class="text-center">
                                          <h6 class="mb-0 text-sm"><?php echo $item["category_id"]?></h6>
                                        </div>
                                 </td>
                                 <td class ='col-1'>
      ...
      <div class="modal-content">
         ...
         <div class="modal-body" >
                 ...
                 <div class="mb-3 price-item gap-3 d-flex justify-content-between align-items-center">
                     <div class="col-11">
                         <div class="w-100">
                             ...
                             <input type="text" class="form-control" id="desc" name="date[]" value="" placeholder="23-05-2023, 24-06-2024, ....">
                         </div>
                         <div class="d-flex justify-content-between align-items-center ">
                             <div class="col-3">
            ...
            <div class="mb-3">
               ...
               <div class="dropdown">
                  <input class="form-control" type="text" value=""  id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="true" placeholder="Chọn điểm khởi hành" readonly/>
            ...
            <div class="mb-3">
               ...
               <div class="dropdown">
                  <input class="form-control" type="text" value=""  id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="true" placeholder="Chọn điểm đến" readonly/>
            ...
            <div class="mt-3">
              ...
              <div class="mt-3">
                  ...
                  <input type="radio" name="status_hot" id="status_hot">
