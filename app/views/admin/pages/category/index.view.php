                        ...
                        <thead>
                           <tr>
                              ...
                              <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">danh
                                 mục cha</th>
                              <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Thứ
                                 tự hiển thị</th>
                              <th
                           ...
                           <tr>
                              <td class=" text-center" style="width: 10px;">
                                 <input type="checkbox" name="id[]" class="mx-auto input-checkbox"
                                    value="<?php echo $category['id'] ?>" style="width: 15px; height:15px">
                              </td>
                              <td>
                              ...
                              <td class="align-middle text-center">
                                 <a href="<?php echo _WEB_ROOT . "/dashboard/category-update/" . $category['id'] ?>"
...
<div class="modal fade" id="modalCreated" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
   <form method="post" action="<?php echo _WEB_ROOT . "/dashboard/category-create" ?>" class="modal-dialog">
      <div class="modal-content">
         ...
         <div class="modal-body">
            ...
            <div class="mb-3">
               ...
               <input type="text" class="form-control" id="display_home" name="display_home"
                  aria-describedby="usernameHelp" value="" placeholder="Chọn số từ 1->">
            </div>
         </div>
