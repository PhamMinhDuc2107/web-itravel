   ...
   <div class="row">
      <div class="col-12">
         <div class="card mb-4">
            ...
            <div class="card-body">
               <form method="post" action="<?php echo _WEB_ROOT . "/dashboard/hotelType-update-post" ?>">
                  <input type="hidden" name="csrf_token" value="<?php echo Session::get("csrf_token") ?>">
                  <input type="hidden" name="id" value="<?php echo $data['hotelType']['id'] ?? "" ?>">
                  <div class="mb-3">
                     <label for="username" class="form-label">Tên</label>
                     <input type="text" class="form-control" name="title"
                        value="<?php echo $data['hotelType']['name'] ?? ""; ?>">
                  </div>
