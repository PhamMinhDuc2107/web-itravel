<div class="container-fluid py-4">
   <div class="row">
      <div class="col-12">
         <form action="<?php echo _WEB_ROOT . "/dashboard/hotelType-delete" ?>" method="post" class="">
            <div class="card mb-4">
                           ...
                           <?php if (!empty($hotelTypes)) : ?>
                              <?php foreach ($hotelTypes as $item): ?>
                                 <tr>
                                    ...
                                    <td class="align-middle text-center">
                                       <a href="<?php echo _WEB_ROOT . "/dashboard/hotelType-update/" . $item['id'] ?>"
...
<div class="modal fade" id="modalCreated" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
   <form method="post" action="<?php echo _WEB_ROOT . "/dashboard/hotelType-create" ?>" class="modal-dialog">
