                            ...
                            <div class="d-flex gap-1 flex-column col-6">
                                ...
                                <div class="dropdown col-12 border-radius-md border border-1 py-1">
                                    ...
                                    <ul class="dropdown-menu w-100 column-options">
                                        ...
                                        <li><a class="dropdown-item" data-value="username" href="<?php echo Util::buildOrderColByUrl("customer_name")?>">Sắp xếp tên</a>
                                        </li>
                                   ...
                                   <?php foreach ($consultations as $item): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div class="d-flex flex-column justify-content-center">
                                                        <h6 class="mb-0 text-sm"><?php echo $item["customer_email"] ?></h6>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div class="d-flex flex-column justify-content-center">
                                                        <h6 class="mb-0 text-sm"><?php echo $item["customer_phone"] ?></h6>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
