            ...
            <div class="card-body">
               <form id="form-submit" method="post" action="<?php echo _WEB_ROOT."/dashboard/tourItinerary-update-post"?>">
                  ...
                  <div class="dropdown mb-3">
                     <input class="form-control formEdit"  type="text"
                            value="<?php foreach ($data['tours'] as $item) {
                               if($item['id'] === $data['tourItinerary']['tour_id']) {
                                  echo $item['name'];
                                  break;
                               }
                  ...
                  <div class="mb-3">
                     ...
                     <input type="text" class="form-control" name="day_number" value="<?php echo $data['tourItinerary']['day_number'] ?? "";?>">
                  </div>
                  <div class="mb-3">
                     <label for="username" class="form-label">Tiêu đề</label>
                     <input type="text" class="form-control" name="title" value="<?php echo $data['tourItinerary']['title'] ?? "";?>">
                  </div>
                  <div class="mb-3">
                     <div id="froala-editor"><?php echo $data['tourItinerary']['content']?></div>
