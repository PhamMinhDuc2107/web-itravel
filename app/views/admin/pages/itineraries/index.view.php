<div class="container-fluid py-4">
   <div class="row">
      <div class="col-12">
         <form action="<?php echo _WEB_ROOT."/dashboard/tourItinerary-delete"?>" method="post" class="">
                  ...
                  <div class="table-responsive p-0">
                     <table class="table align-items-center mb-0 min-vh-50">
                        ...
                        <tr>
                           ...
                           <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2 col-1">Ngày số mấy</th>
                        ...
                        <?php
                        $tourItineraries = $data['tourItineraries'] ??[];
                        ?>
                        <?php if(!empty($tourItineraries)) : ?>
                           <?php foreach($tourItineraries as $item): ?>
                              <tr>
                                 ...
                                 <td>
                                    <div class="d-flex px-2 py-1">
                                       <div class="d-flex flex-column justify-content-center">
                                          <h6 class="mb-0 text-sm"><?php echo $item["day_number"]?></h6>
                                       </div>
                                    </div>
                                 </td>
                                 <td>
                                 ...
                                 <td class="align-middle text-center">
                                    <a href="<?php echo _WEB_ROOT."/dashboard/tourItinerary-update/".$item['id']?>" class="text-secondary font-weight-bold text-xs " style="margin-bottom: 0;"
                                       id="btnEdit"
                                    >
                                       Edit
                                    </a>
...
<div class="modal modal-lg fade" id="modalCreated" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
   <form method="post" action="<?php echo _WEB_ROOT."/dashboard/tourItinerary-create"?>" class="modal-dialog">
      <div class="modal-content">
         ...
         <div class="modal-body" >
            ...
            <div class="mb-3">
               <label for="day_number" class="form-label">Ngày số mấy</label>
               <input type="text" class="form-control" id="day_number" name="day_number" aria-describedby="usernameHelp" value="">
            </div>
            <div class="mb-3">
