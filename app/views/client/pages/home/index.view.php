    ...
    <div class="tour__container tabs">
      ...
      <div class="tour-swiper swiper">
        <div class="tour__list swiper-wrapper tab--content tab__content--active" data-tab="0">
          ...
          <div class="tour__item swiper-slide">
            <div class="tour__img">
              <img src="<?php echo _WEB_ROOT . $itemTourAll['image'] ?>" alt="<?php echo $itemTourAll['name'] ?>">
              <div class="tour__info--transport">
      ...
      <div class="tour-swiper swiper">
        <div class="tour__list swiper-wrapper tab--content" data-tab="<?php echo $location['id'] ?>">
          <div class="tour__item swiper-slide">
            <div class="tour__img">
              <img src="<?php echo _WEB_ROOT . $displayTour['image'] ?>" alt="<?php echo $displayTour['name'] ?>">
              <div class="tour__info--transport">
          ...
          <div class="favorite__item">
            <div class="favorite__item--text">
              <?php
                                    ...
                                    ?>
              <a href="<?php echo _WEB_ROOT . '/' . $slug . Util::buildUrlParams(['destination' => $item['slug']]) ?>">
      ...
      <div class="blog__wrap">
        ...
        <div class="blog__list">
          ...
          <div class="blog__item blog__item--full">
            <div class="detail">
              <img src="<?php echo _WEB_ROOT . $firstBlog['thumbnail'] ?>" alt="<?php echo $firstBlog['title'] ?>">
              <div class="info">
                <a
