            ...
            <div class="container">
                <div class="tour__container tabs">
                        ...
                        <ul class="tour__nav--list">
                           <?php if (isset($categoryData['locations'])): ?>
                              ...
                              <?php foreach ($categoryData['locations'] as $index => $location): ?>
                                   <li class="tour__nav--item tab--link"
                                       data-tab="<?php echo $location['id'] ?>">
                    ...
                    <div class="tour-swiper swiper">
                        <div class="tour__list swiper-wrapper tab--content tab__content--active"
                             data-tab="0">
                   ...
                   <?php if (isset($categoryData['locations']) && isset($categoryData['tours'])): ?>
                      <?php foreach ($categoryData['locations'] as $index => $location): ?>
                         ...
                         if (!empty($locationTours)):
                            ...
                            ?>
                             <div class="tour-swiper swiper">
                                 <div class="tour__list swiper-wrapper tab--content"
                                      data-tab="<?php echo $location['id'] ?>">
                                     <div class="tour__item swiper-slide">
                                         <div class="tour__img">
                                                 ...
                                                 <div class="tour__detail--top">
                                                     <div class="tour__detail--depart">
                                                         <svg fill="#615c5c" height="17px" width="17px" version="1.1"
                                                              ...
                                                              stroke="#615c5c"><g id="SVGRepo_bgCarrier"
                                                                                  stroke-width="0"></g>
                                                             <g id="SVGRepo_tracerCarrier" stroke-linecap="round"
                                                                stroke-linejoin="round"></g>
                                                             <g id="SVGRepo_iconCarrier">
                      ...
                      <?php foreach ($data['firstLocationCate'] as $item): ?>
                           <div class="favorite__item">
                               <div class="favorite__item--text">
                                   <a href="<?php echo $item['slug'] ?>"><?php echo htmlspecialchars($item['name']); ?></a>
                               </div>
                      ...
                      <?php $firstBlog = reset($data['listBlogHot']) ?>
                       <div class="blog__item blog__item--full">
                           <div class="detail">
                               ...
                               <div class="info">
                                   <a href="<?php echo _WEB_ROOT . '/tin-tuc/' . $firstBlog['slug'] ?>"><?php echo $firstBlog['title'] ?></a>
                   ...
                   <div class="blog__list blog__list--full">
                      <?php foreach ($data['listBlogHot'] as $blog): ?>
                          <div class="blog__item">
                              <div class="detail">
                                  <img src="<?php echo _WEB_ROOT . $blog['thumbnail'] ?>"
                                       alt="<?php echo $blog['title'] ?>">
                                  <div class="info">
                                      <a href="<?php echo _WEB_ROOT . '/tin-tuc/' . $firstBlog['slug'] ?>"><?php echo $blog['title'] ?></a>
