                    ...
                    <div class="swiper-wrapper">
                        <?php if(isset($data['listImg'])):?>
                            <?php foreach($data['listImg'] as $img):?>
                                <img src="<?php echo _WEB_ROOT.$img['image']?>" alt="<?php echo $data['tour']['name']?>" class="pDetail__img swiper-slide ">
                            <?php endforeach;?>
                        <?php endif;?>
                    </div>
                </div>
                               ...
                               <div class="tour__detail">
                                   ...
                                   <div class="tour__detail--bottom">
                                       ...
                                       <div class="tour__detail--quantity">
                                           <a href="<?php echo _WEB_ROOT.'/order-booking/'.$tour['code_tour']?>" class="btn btn-booking">Đặt ngay</a>
                                       </div>
                                   </div>
                               </div>
                           </div>
