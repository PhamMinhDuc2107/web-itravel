            ...
            <div class="sidebar__wrap">
               <h3  class="sidebar__title">Bộ lọc tìm kiếm</h3>
                <div class="sidebar__filter">
                    ...
                    <input type="text" id="date-departure" placeholder="Chọn ngày khởi hành" value="<?php echo htmlspecialchars(Request::input('fromDate', ""))?>" name="fromDate" style="width: 100%; border:1px solid #e9e9e9;border-radius: 6px;padding: 10px; height: 40px;">
                </div>

            <div class="sidebar__filter--price sidebar__filter">
               <h3 class="filter__title">Chọn mức giá</h3>
               <ul class="filter__list">
                  <li class="filter__item <?php echo  Request::input("budgetId") === "1"? "filter__item--active" :""?>" data-param="budgetId" data-value="1">
                     Dưới 5 triệu
                  </li>
                  <li class="filter__item <?php echo  Request::input("budgetId") === "2"? "filter__item--active" :""?>" data-param="budgetId" data-value="2">
                    Từ 5 - 10 triệu
                  </li>
                  <li class="filter__item <?php echo  Request::input("budgetId") === "3"? "filter__item--active" :""?>" data-param="budgetId" data-value="3">
                     Từ 10 - 20 triệu
                  </li>
                  <li class="filter__item <?php echo  Request::input("budgetId") === "4"? "filter__item--active" :""?>" data-param="budgetId" data-value="4">
                    Trên 20 triệu
                  </li>
               </ul>
            </div>
         ...
         <div class="product__right">
            <div class="product__sortbar">
               ...
               <ul class="filter__list">
                    ...
                    <li class="filter__item"data-param="fromDate" data-value="<?php echo Util::formatDate(date('d-m-Y'))?>">
                                    ...
                                    <div class="tour__detail">
                                        <div class="tour__detail--top">
                                            ...
                                            <div class="tour__detail--depart">
                                                ...
                                                <div>
                                                    <span> Lịch khởi hành: <?php echo $tour['date'] !== null ? Util::formatDate($tour['date']):"Liên hệ" ?></span>
                                                </div>
                                            </div>
                                            <div class="tour__detail--depart">
                        ...
                        <ul class="pagi__list">
                            ...
                            ?>
                                <?php for($i = 1; $i<= $totalPages; $i++) :?>
                                    <li class="pagi__item"><a href="<?php echo Util::buildPageUrl($i)?>" class="pagi__item--link <?php echo $i === (int)htmlspecialchars($page) ? "active" :""?>"><?php echo $i?></a></li>
                                <?php endfor;?>
                        </ul>
                    </div>
                <?php endif;?>
    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            if (res.type === 'success' && res.data && res.data.length > 0) {
                ...
                tourList.html(`<h3 style="font-size: 30px; font-weight: 600; text-align: center">Không tìm thấy tour du lịch nào</h3>`);
            }
        },
        error: function () {
            tourList.html(`<h3 style="font-size: 30px; font-weight: 600; text-align: center">Không tìm thấy tour du lịch nào</h3>`);
