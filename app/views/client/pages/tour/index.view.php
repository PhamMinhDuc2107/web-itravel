         ...
         <form class="sidebar">
            ...
            <div class="sidebar__wrap">
               ...
               <div class="sidebar__filter--price sidebar__filter">
                  <div class="sidebar__filter--wrap">
         ...
         <div class="product__right">
            ...
            <div class="tour__wrap">
                  ...
                  <div class="tour__item swiper-slide">
                     ...
                     <div class="tour__item--wrap">
                        <div class="tour__name">
                           <a
                              href="<?php echo _WEB_ROOT . '/du-lich/' . $tour['slug'] ?>"><?php echo $tour['name'] ?></a>
                        </div>
               ...
               <div class="tour__loading"
                  style="width:100%; height:100%; display:flex; align-items:center; justify-content:center;display:none">
                  <img style="width:300px" src=" <?php echo ASSET ?>/client/images/loading.gif" alt="Loading...">
               </div>
            </div>
            <!-- product -->
...
function updateToursWithFilters() {
   const tourLoading = document.querySelector(".tour__loading")
...
document.addEventListener("DOMContentLoaded", function(e) {
  ...
  `
   ...
   if (!document.querySelector('.filter__remove') && isActivePrice) {
      sidebarFilterWrap.insertAdjacentHTML("beforeend", htmlRemoveBtn);
   }
})
</script>
