                    ...
                    <div class="hotel__sidebar--item">
                        ...
                        <div class="filter__list">
                            <div class="filter__item" data-type="budgetId" data-value="1">
                                <input type="checkbox"
                                       id="price1" <?= $isParamPrice && in_array("1", $budgetId) ?
                                    "checked" : ""
                                ?>>
                        ...
                        <div class="filter__list">
                            ...
                            <?php if (!empty($hotelTypes)): ?>
                                <?php foreach ($hotelTypes as $hotelType): ?>
                                    <div class="filter__item" data-type="hotelType"
                                         data-value="<?php echo $hotelType['id'] ?>">
                                        <input type="checkbox"
                                               id="<?php echo "ht" . $hotelType['id'] ?>" <?=
                    ...
                    <div class="hotel__sidebar--item">
                        ...
                        <div class="filter__list">
                            <div class="filter__item" data-type="sortRating" data-value="1">
                                <input type="checkbox"
                                       id="1" <?= $isParamRating && in_array("1", $sortRating) ?
                                    "checked" : ""
                                ?>>
            ...
            <div class="hotel__right">
                <div class="hotel__sortbar">
                    ...
                    <ul class="hotel__sortbar--list">
                        ...
                        Request::input
                        ("orderBy") === "price" ? "hotel__sortbar--active" : "" ?>"
                            data-order="desc" data-orderBy="price">
                            Đắt nhất
                        </li>
                        <li class="hotel__sortbar--item <?= Request::input("order") === "desc" &&
                        Request::input
                        ("orderBy") === "rating" ? "hotel__sortbar--active" : "" ?>"
                            data-order="desc" data-orderBy="rating">
                            Hạng sao
                        </li>
                        <li class="hotel__sortbar--item <?= Request::input("order") === "desc" &&
                        Request::input
                        ("orderBy") === "overall_rating" ? "hotel__sortbar--active" : "" ?>"
                            data-order="desc" data-orderBy="overall_rating">
                            Đánh giá
                        </li>
                    </ul>
                </div>
                    ...
                    <?php if (!empty($hotels)): ?>
                        <?php foreach ($hotels as $hotel): ?>
                            <div class="hotel__item">
                                ...
                                <div class="hotel__item--info">
                                    ...
                                    <div class="info__location">
                                        <svg fill="#333" height="20px" width="20px" version="1.1"
                                             id="Capa_1"
                           ...
                           <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                        ...
                                        <span class="info__location--link dialog__btn"
                                              data-type="map" data-id="<?php echo $hotel['id'] ?>">Xem bản đồ</span>
                                        <?php
                                        $adrress = $hotel["name"] . ', ' . $hotel['address'] . ", " . $hotel['city'] . ", " . $hotel["country"];
                                        $stringAdress = Util::processSearchStringMap($adrress);
                                        ?>
                                        <div class="dialog" data-type="map"
                              ...
                              <?php endif; ?>
                                    ...
                                    <div class="info__bottom">
                                        ...
                                        <div class="info__price">
                                            ...
                                            <a href="<?php echo _WEB_ROOT . '/khach-san/' . $hotel['slug'] ?>"
                                               class="info__btn btn">
                                                Xem phòng
